...
class GCILCIFAR100(ContinualDataset):
    ...
    def __init__(self, args: Namespace) -> None:
        ...
        trainset = MyCIFAR100(base_path() + 'CIFAR100', train=True, download=True, transform=transform)
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), transforms.Compose(GCILCIFAR100.TRANSFORM)])
        return transform
    ...
    def get_norm_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), transforms.Compose(GCILCIFAR100.TRANSFORM_NORM)])
        return transform
